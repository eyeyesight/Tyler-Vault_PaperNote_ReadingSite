 ...
 *
 * @typedef {{backlinksMarkup:string,backToTopMarkup:string,graphMarkup:string,runtimeScripts:string}} ProjectPageNavigation
...
function renderSharedProjectPageStructure(html, layout, navigation) {
  ...
  normalized = normalized.replace("</article>", `${navigation.graphMarkup}${navigation.backToTopMarkup}</article>`)
