...
export function createQuartzPublicNavigation({ entries, route, currentPublicId = null, backlinks = [] }) {
  ...
  return Object.freeze({
    ...
    explorerShellMarkup: `<aside class="explorer" aria-label="Library" aria-expanded="true"><h2 class="desktop-explorer">Library</h2><button type="button" class="explorer-toggle mobile-explorer" aria-label="Toggle Library" aria-controls="tracer-explorer-content" aria-expanded="true">Library</button><div id="tracer-explorer-content" class="explorer-content" aria-expanded="true"><ul class="explorer-ul"></ul></div></aside>`,
