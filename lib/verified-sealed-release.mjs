...
/** @typedef {{runtimeRoot:string,releasesRoot:string,manifestId:string,releaseRoot:string,release:Release,authority:SealedReleaseAuthority,evidenceDigest:string}} VerifiedState */
...
async function readVerifiedState(input) {
  ...
  return { runtimeRoot, releasesRoot, manifestId: input.manifestId, releaseRoot, release, authority, evidenceDigest }
}
